  ...
  return (
    <div className="app-shell">
      ...
      <main className="mobile-page">
        ...
        {activeTab === "business" && <BusinessView summary={summary} costs={currentCosts} productCount={activeProducts.length} period={selectedPeriod} onPeriodChange={setSelectedPeriod} onPricing={() => setShowPricing(true)} onRecord={() => setShowQuickRecord(true)} onSale={() => setShowSaleRecord(true)} />}
...
export function ProductsView({ products, activeProductId, onSelect, onPricing, productCostAction, productCostLabel, onQuickCost, onBom, onAdd, onDelete }: { products: LedgerProduct[]; activeProductId: number; onSelect: (id: number) => void; onPricing: () => void; productCostAction: string; productCostLabel: string; onQuickCost: () => void; onBom: () => void; onAdd: () => void; onDelete?: (product: LedgerProduct) => void }) {
